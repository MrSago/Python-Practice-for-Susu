...
my_module.hello_world("Pikachu")     # Вызовите функцию hello_world из модуля my_module 
...
hello_world("Naruto")    # Функция hello_world должна вызываться без указания модуля
